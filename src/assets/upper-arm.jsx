...
export default function UpperArm ({choices,setChoices, symptomsUpperArm, setSymptomsUpperArm}) {
   ...
   aria-label="contacts"
 >
     {symptomsUpperArm.map((e)=>{
         return(
             <ListItem disablePadding>
     <ListItemButton onClick={()=>{
         setSymptomsUpperArm(
             symptomsUpperArm.filter(item => item.name !== e.name)
         )
