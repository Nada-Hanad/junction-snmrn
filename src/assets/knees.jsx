...
export default function Knees ({choices,setChoices, symptomsKnees, setSymptomsKnees}){
 ...
 >
     ...
     <ListItemButton onClick={()=>{
         setSymptomsKnees(
             symptomsKnees.filter(item => item.name !== e.name)
         )
