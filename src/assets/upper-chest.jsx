...
export default function UpperChest({choices,setChoices, symptomsUpperChest, setSymptomsUpperChest}){
   ...
   aria-label="contacts"
 >
     {symptomsUpperChest.map((e)=>{
         return(
             <ListItem disablePadding>
     <ListItemButton onClick={()=>{
         setSymptomsUpperChest(
             symptomsUpperChest.filter(item => item.name !== e.name)
         )
