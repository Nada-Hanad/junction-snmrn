...
export default function Thighs({choices,setChoices, symptomsThighs, setSymptomsThighs}){
   ...
   aria-label="contacts"
 >
     {symptomsThighs.map((e)=>{
         return(
             <ListItem disablePadding>
     <ListItemButton onClick={()=>{
         setSymptomsThighs(
             symptomsThighs.filter(item => item.name !== e.name)
         )
